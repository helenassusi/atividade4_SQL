...
--comando para verificar informacoes do DB
exec sp_helpdb LocadoraDB;

--comando pra selecionar o BD a ser usado
use LocadoraDB;
...
--comando para adicionar uma nova coluna no BD
alter table Cliente 
add CPF varchar(11);

--comando para inserir dados em uma tabela
insert into Cliente Values
(1, 'João Silva', 'joao@email.com', '(14) 997155192', '1990-01-05', '12345678911' ),
(2, 'Maria Souza', 'maria@email.com', '(14) 996519824', '1983-06-12', '49109267808' );
...
(2, 'ALIVE', 2020, 2),
(3, 'Se Beber Não Case', 2015, 3);

insert into Filmes Values
(4, 'BLACKPINK DOCUMENTÁRIO', 2023, 4);

insert into Locacao Values
(1, 1, 1, '2025-06-01', '2025-06-05'),
(2, 2, 2, '2024-08-30', '2024-09-03');

select * from Cliente

--comando para atualizar dados
update Cliente 
set Telefone = '(14) 997155192'
where IDCliente = 1;

--consultas com SELECT 
select * from Categoria;

select AnoLancamento , Titulo	 
from Filmes;
...
--comando para eliminar valores duplicados
select distinct IDCategoria
from Filmes;

--comando para criar uma tabela com dados de outra
select Nome, Email
...
(3, 'Ana Silva', 'ana.silva@email.com', '(11) 98877-1234', '1990-05-12', '12345678901'),
...
--alterar um nome de uma coluna 
EXEC sp_rename 'NomeTabela.NomeColunaAntiga', 'NomeColunaNova', 'COLUMN';
...
--comando usado para ordenar os resultados de uma consulta com base em uma ou mais colunas
...
--comando para filtrar registros que correspondem a uma lista de valores
select * from Filmes
...
--comando que retorna resultados se pelo menos um for verdade
select * from Filmes
where AnoLancamento = '2016' or PrecoFilmes = '59.99';
...
--Listar os filmes lançados entre 2018 e 2021 (inclusive)
select * from Filmes
...
--Mostrar o título e ano de lançamento dos filmes da categoria Aventura ordenados do mais recente para o mais antigo
select Titulo, AnoLancamento
from Filmes
where IDCategoria = '9'
